...
const {getTypes, isObject} = require('./handle')
...
const createTable = (db, name, obj, autoId=true)=>{
    try{
...
const insertRows = (db, table, data)=>{
...
const updateRows = (db, table, param, where)=>{
...
const deleteRows = (db, table, where)=>{
...
const getResults = async (db,table, where)=>{
try{
...
module.exports = {dataBase, createTable, insertRows, updateRows, deleteRows, getResults}
